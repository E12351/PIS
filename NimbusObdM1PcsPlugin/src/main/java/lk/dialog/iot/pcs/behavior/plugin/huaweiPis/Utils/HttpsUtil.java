...
//	}
	...
	public StreamClosedHttpResponse doGetWithParas(String url, Map<String, String> queryParams, Map<String, String> headerMap)
			throws Exception {
	...
	public String getHttpResponseBody(HttpResponse response)
		...
		if (response instanceof StreamClosedHttpResponse) {
			...
			if (entity != null && entity.isStreaming()) {
				...
				body = lk.dialog.iot.pcs.behavior.plugin.huaweiPis.Utils.StreamUtil.inputStream2String(entity.getContent(),
						encoding);
			}
		}
